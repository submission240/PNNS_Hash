...
// -----------------------------------------------------------------------------
void MFH_Hash::calc_transform_centroid( // data transformation with output centroid
	const float *data,					// input data
...
// -----------------------------------------------------------------------------
float MFH_Hash::calc_transform_dist( // calc l2-dist after data transformation 
	const float *data,					// input data
...
// -----------------------------------------------------------------------------
void MFH_Hash::transform_data(		// data transformation
	const float *data,					// input data
...
// -----------------------------------------------------------------------------
void MFH_Hash::display()			// display parameters
{
	printf("Parameters of MFH_Hash:\n");
	printf("    n       = %d\n",   n_pts_);
	printf("    dim     = %d\n",   dim_);
	printf("    fh_dim  = %d\n",   fh_dim_);
	printf("    b       = %.2f\n", b_);
...
// -----------------------------------------------------------------------------
int MFH_Hash::nns(					// point-to-hyperplane NNS
...
// -----------------------------------------------------------------------------
void MFH_Hash::transform_query(		// query transformation
	const float *query,					// input query
