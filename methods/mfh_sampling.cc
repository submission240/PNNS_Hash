...
// -----------------------------------------------------------------------------
MFH_Hash_Sampling::MFH_Hash_Sampling( // constructor
...
// -----------------------------------------------------------------------------
void MFH_Hash_Sampling::transform_data( // data transformation
	const  float *data,					// input data
...
// -----------------------------------------------------------------------------
int MFH_Hash_Sampling::sampling(	// sampling coordinate based on prob
	int   d,							// dimension
...
// -----------------------------------------------------------------------------
float MFH_Hash_Sampling::calc_transform_dist( // calc l2-dist-sqr after transform
...
// -----------------------------------------------------------------------------
MFH_Hash_Sampling::~MFH_Hash_Sampling()	// destructor
{
	if (!hash_.empty()) {
...
// -----------------------------------------------------------------------------
void MFH_Hash_Sampling::display()	// display parameters
{
	printf("Parameters of MFH_Hash_Sampling:\n");
	printf("    n            = %d\n",   n_pts_);
	printf("    dim          = %d\n",   dim_);
...
// -----------------------------------------------------------------------------
int MFH_Hash_Sampling::nns(			// point-to-hyperplane NNS
...
// -----------------------------------------------------------------------------
void MFH_Hash_Sampling::transform_query(// query transformation
	const  float *query,				// input query
