...
// -----------------------------------------------------------------------------
FH_Hash_Sampling::FH_Hash_Sampling(	// constructor
...
// -----------------------------------------------------------------------------
void FH_Hash_Sampling::transform_data( // data transformation
	const  float *data,					// input data
...
// -----------------------------------------------------------------------------
int FH_Hash_Sampling::sampling(		// sampling coordinate based on prob
	int   d,							// dimension
...
// -----------------------------------------------------------------------------
FH_Hash_Sampling::~FH_Hash_Sampling() // destructor
{
	if (lsh_ != NULL) { delete lsh_; lsh_ = NULL; }
}

// -----------------------------------------------------------------------------
void FH_Hash_Sampling::display()	// display parameters
{
	printf("Parameters of FH_Hash_Sampling:\n");
	printf("    n            = %d\n",   n_pts_);
	printf("    dim          = %d\n",   dim_);
...
// -----------------------------------------------------------------------------
int FH_Hash_Sampling::nns(			// point-to-hyperplane NNS
...
// -----------------------------------------------------------------------------
void FH_Hash_Sampling::transform_query( // query transformation
	const  float *query,				// input query
	int    &sample_d,					// sample dimension (return)
