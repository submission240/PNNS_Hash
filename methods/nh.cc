...
// -----------------------------------------------------------------------------
void NH_Hash::transform_data(		// data transformation
	const float *data,					// input data
...
// -----------------------------------------------------------------------------
NH_Hash::~NH_Hash()					// destructor
{
	if (lsh_ != NULL) { delete lsh_; lsh_ = NULL; }
}

// -----------------------------------------------------------------------------
void NH_Hash::display()				// display parameters
{
	printf("Parameters of NH_Hash:\n");
	printf("    n      = %d\n",   n_pts_);
	printf("    dim    = %d\n",   dim_);
	printf("    nh_dim = %d\n",   nh_dim_);
	printf("    m      = %d\n",   lsh_->m_);
...
// -----------------------------------------------------------------------------
int NH_Hash::nns(					// point-to-hyperplane NNS
...
// -----------------------------------------------------------------------------
void NH_Hash::transform_query(		// query transformation
	const float *query,					// input query
