...
// -----------------------------------------------------------------------------
void FH_Hash::transform_data(		// data transformation
	const float *data,					// input data
...
// -----------------------------------------------------------------------------
FH_Hash::~FH_Hash()					// destructor
{
	if (lsh_ != NULL) { delete lsh_; lsh_ = NULL; }
}

// -----------------------------------------------------------------------------
void FH_Hash::display()				// display parameters
{
...
// -----------------------------------------------------------------------------
int FH_Hash::nns(					// point-to-hyperplane NNS
...
// -----------------------------------------------------------------------------
void FH_Hash::transform_query(		// query transformation
	const float *query,					// input query
